# -*- coding: utf-8 -*-
"""kesetimbangan_662023007

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yT3iSrNuKiCKtV58QQxI60pyivAQlfQw
"""

import numpy as np #packages untuk membaca fungsi
import matplotlib.pyplot as plt

#Rentang nilai x dan waktu medan vektor
x = np.arange(0, 3, 0.1)
t = np.arange(0, 4, 0.1)
T, X = np.meshgrid(t, x)
...
#Definisikan sistem
dX = -X**2 + 3 * X - 2
dT = np.ones(dX.shape) #dijadikan satu
...
U = np.ones_like(T) #Arah horizontal tetap untuk menunjukkan dalam waktu
...
plt.axhline(Ta, color='red', linestyle='--', label='Solusi detimbang (T=Ta)')
plt.xlabel('t (waktu)')
plt.ylabel('T (Suhu)')
